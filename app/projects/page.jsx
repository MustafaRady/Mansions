    ...
    <div className='w-full flex justify-center'>
      <div className='w-full lg:w-4/5 flex flex-col lg:flex-row gap-7 lg:p-16'>
        ...
        <div className='flex-1 '>
          <form class="mx-auto p-4 bg-white  flex flex-col gap-5">
            <div class="mb-4 flex flex-col ">
              <label id='label-1' for="fullName" className="mb-2">Full Name</label>
              <input type="text" id="fullName" name="fullName" class="input"/>
            </div>

            <div class="mb-4 flex flex-col">
              <label id='label-2' for="phoneNumber" >Phone Number</label>
    ...
    <div className='w-full pt-16'>
        ...
        <div className='w-4/5 mx-auto flex flex-col lg:flex-row gap-3 mt-16'>
          <div className='flex justify-start flex-col text-4xl flex-1 lg:pl-28'>
            ...
            <strong>WILSONS</strong>
          </div>

          <div className='flex flex-col gap-3 flex-1 '>
            <h1 className='text-xl font-semibold'>THE WILSONS NAME</h1>
            <p>Putting the established Wilsons brand to your upcoming project adds a unique layer of credibility. The most successful developments occur when the purchasing public trust the people behind, and in front of, the project. Working with Wilsons projects means the opportunity to buy into Wilsons’ strong local associations, broad client database, and their intimate knowledge of how to negotiate for the best possible outcome.</p>
          </div>
        </div>
          ...
          <div className='flex flex-1 flex-col justify-start items-center'>
            <div className='w-4/5 lg:w-2/3 lg:p-6'>
              ...
              <div className='flex flex-col gap-10 w-full mt-12'>
                <p>Wilsons entered the project marketing landscape some 50 years ago, selling ground breaking commercial and residential properties that today form the backbone of the city and surrounds as we know them.</p>
          ...
          <div className='w-full py-8 flex xl:flex-row flex-col gap-4 p-4'>
            ...
            <div className='flex-1 flex justify-center'>
              <div className='w-full xl:w-2/3 flex flex-col gap-10'>
                ...
                <p>James Wilson, Director of Wilsons Real Estate, is a leader in Geelong real estate and will offer his 20-plus years of experience to every project undertaken. He’ll work closely with valuers, engineers, builders and other development consultants to ensure the project is taken from infancy to completion.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className='w-full py-8 flex xl:flex-row flex-col-reverse gap-4 p-4'>
            <div className='flex-1 flex justify-center'>
              <div className='w-full xl:w-2/3 flex flex-col gap-10'>
                ...
                <p>Wilsons will take a thoughtful and considered approach, targeting the project to local and extended networks, utilising a database of qualified buyers.</p>
